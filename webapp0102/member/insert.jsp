...
클라이언트의 html 문서로부터 전송되어온, 파라미터들을 넘겨받아 오라클에 넣어보자, 특히 오라클에 넣을 때
기존 javsSE 시절의 연동코드를 그대로 사용하면 됨 
*/

//클라이언트에서 전송된 파라미터 받기!
//내장 객체 중 요청 정보를 가진 request 객체를 사용해야 함 
...
//넘겨받은 파라미터 (전송 되어 온 변수)들을 오라클에 넣기 
//코드를 분리시키지 않고 (dao 없이) 그냥 진행

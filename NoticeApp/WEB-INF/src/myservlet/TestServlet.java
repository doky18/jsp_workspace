/*
자바는 클래스 기반의 언어이므로, javaEE를 개발할 때도 분명 jsp가 아니더라도,
...
public class TestServlet extends HttpServlet{
	...
	//클라이언트가 get 방식으로 요청을 하면 doGet()으로 처리하고, 
	//클라이언트가 post 방식으로 요청하면 doPost()로 처리하면 된다

	//작성된, 서블릿 클래스는 웹브라우저에서 그 명칭을 직접 접근할 수 없다.. 해결책? 매핑을 통해서 sun에서 정한 규칙을 따르자
